...
class jointournamentScreen extends StatefulWidget {
  ...
  static const String id = 'jointournament_screen';
...
class _jointournamentScreenState extends State<jointournamentScreen> {
  ...
  fetchData() async {
    data = await supabase.from('tournament').select("tr_id");
    print("data are: $data");
  }
  ...
  insertData(
      String member_uuid, String tr_id, String position, int jersey_no) async {
